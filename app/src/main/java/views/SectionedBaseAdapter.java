...
public abstract class SectionedBaseAdapter extends BaseAdapter implements GroupListView.PinnedSectionedHeaderAdapter {
    ...
    /**
     * 
     * @Description 判断是不是最后一条分组的
     */
     public final boolean isLastItemByGroup( int position){
    	 return true;
     }
