...
public class SelectPicPopupWindow extends PopupWindow {
    private Button btn_phoneNum, btn_cancel;
    ...
    public SelectPicPopupWindow(Activity context, View.OnClickListener itemsOnClick) {
        ...
        btn_phoneNum = (Button) mMenuView.findViewById(R.id.btn_phoneNum);
        ...
        //设置按钮监听
        btn_phoneNum.setOnClickListener(itemsOnClick);
